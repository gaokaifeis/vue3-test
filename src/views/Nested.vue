<template>
  <div>
    ...
    <ul v-if="level === 1">
      ...
      <li>
        <router-link to="/nested/nested/nested">/nested/nested/nested</router-link>
      </li>
      <li>
        <router-link to="/anidado/a/nested">/anidado/a/nested</router-link>
      </li>
      <li>
        <router-link to="/anidado/nested/nested">/anidado/nested/nested</router-link>
      </li>
      <li>
      ...
      <li>
        <router-link to="/nested/also-as-absolute">/nested/also-as-absolute</router-link>
      </li>
      <li>
        <router-link to="/absolute">/absolute</router-link>
      </li>
      <li>
        <router-link :to="{ name: 'absolute-child' }">/absolute (named)</router-link>
      </li>
    </ul>
