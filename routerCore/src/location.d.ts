 ...
 */
export declare function isSameRouteLocation(a: RouteLocation, b: RouteLocation): boolean;
/**
...
export declare function isSameLocationObject(a: RouteLocationNormalized['query'], b: RouteLocationNormalized['query']): boolean;
export declare function isSameLocationObject(a: RouteLocationNormalized['params'], b: RouteLocationNormalized['params']): boolean;
export {};
