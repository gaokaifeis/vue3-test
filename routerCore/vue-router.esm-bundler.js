...
function guardToPromiseFn(guard, to, from, instance) {
    return () => new Promise((resolve, reject) => {
        ...
        Promise.resolve(guard.call(instance, to, from, (process.env.NODE_ENV !== 'production') ? canOnlyBeCalledOnce(next, to, from) : next)).catch(err => reject(err));
    });
}
...
function createRouter(options) {
    ...
    function resolve(rawLocation, currentLocation) {
        ...
        if ((process.env.NODE_ENV !== 'production') && hash && hash[0] !== '#') {
